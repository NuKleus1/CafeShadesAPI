    ...
    public class MappingProfiles : Profile
    {
        public MappingProfiles()
        {
            CreateMap<Product, ProductDto>()
                ...
                .ForMember(dest => dest.productQuantity, o => o.MapFrom(src => src.Quanity))
                .ForMember(dest => dest.productImage, o => o.MapFrom(src => src.ImageUrl))
                ...
                .ForMember(dest => dest.total, o => o.MapFrom(src => src.Price * src.Quanity))
                .ReverseMap();
            ...
            CreateMap<OrderItem, ProductDto>()
                ...
                .ForMember(dest => dest.productImage, o => o.MapFrom(src => src.Product.ImageUrl))
            ...
            CreateMap<Category, CategoryDto>()
                ...
                .ForMember(dest => dest.CategoryImage, opt => opt.MapFrom(src => src.ImageUrl))
